import { getBrutalistAiImageUrl } from './imagePromptGuide';
...
export const ARTICLES: Article[] = [
  {
    ...
    date: '25 LUGLIO 2026',
    readTime: '7 MIN READ',
    heroImage: getBrutalistAiImageUrl('Inauguriamo la nuova rubrica economico-esistenziale con la lezione finanziaria di Carmen Consoli: quando l\'amore stenta ad accendersi, non sa quando è il tuo compleanno e non c\'è quando piangi, l\'unica soluzione è convertire il vuoto affettivo in carte di credito fittizie!', 'ECONOMIA E DISPERAZIONE', 1),
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '6 MIN READ',
    heroImage: getBrutalistAiImageUrl('Incontrata a nove anni sul ponte, mai preso un caffè insieme eppure protagonista di tre cantiche: indagine sul relazione più a distanza della letteratura italiana tra salutini di sfuggita e viaggi ultraterreni.', 'ACCOPPIAMENTO E DINTORNI', 2),
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '6 MIN READ',
    heroImage: getBrutalistAiImageUrl('Sei mogli, una Chiesa creata da zero per disperazione amorosa e il Tinder del Cinquecento: storia di un sovrano che non sapeva come dire \'prendiamoci una pausa\' e finì per rifare la mappa religiosa d\'Europa.', 'ACCOPPIAMENTO E DINTORNI', 3),
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '6 MIN READ',
    heroImage: getBrutalistAiImageUrl('Inauguriamo la nuova serie di interviste ai grandi pensatori partendo dai Presocratici: Talete, Anassimandro, Anassimene ed Eraclito ci svelano l\'origine dell\'universo tra pozzi, aria rarefatta, l\'Apeiron infinito e il fiume della pigrizia.', 'FILOSOFIA DEL NULLA', 4),
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '5 MIN READ',
    heroImage: '/MARCUS.png',
    imageAlt: 'Coach Marcus in posa motivazionale in canottiera e ciabatte sanitarie',
    imageCutoutStyle: 'paper-tape',
    featured: true,
    gridSpan: 'full',
    likesCount: 42100,
  ...
  },
  {
    ...
    readTime: '6 MIN READ',
    heroImage: '/MARCUS.png',
    imageAlt: 'Coach Marcus - Il maestro dell\'andare in bianco con dignità e logorrea',
    imageCutoutStyle: 'paper-tape',
    featured: true,
    gridSpan: 'full',
    likesCount: 31200,
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '6 MIN READ',
    heroImage: '/TERESA.png',
    imageAlt: 'Teresa l\'Operatrice e Cartomante dell\'Assurdo con i suoi tarocchi unti',
    imageCutoutStyle: 'paper-tape',
    featured: true,
    gridSpan: 'full',
    likesCount: 24150,
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '7 MIN READ',
    heroImage: getBrutalistAiImageUrl('Siamo entrati nel tempio milanese del Bruttalismo Facciale: tra fango della Martesana, impacchi al gorgonzola piccante e permanente al baffo da terrore bancario. In esclusiva: la super PROMO \'Insonnia & Pori Splendenti\'!', 'ESTETICA & BELLEZZA BRUTTA', 5),
  ...
  },
  {
    ...
    readTime: '5 MIN READ',
    heroImage: '/TERESA.png',
    imageAlt: 'Teresa l\'Operatrice Cartomante dell\'Assurdo',
    imageCutoutStyle: 'paper-tape',
    featured: true,
    gridSpan: 'full',
    likesCount: 12580,
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '6 MIN READ',
    heroImage: getBrutalistAiImageUrl('Basta correttori illuminanti e patch al retinolo! Ecco la rivoluzionaria skincare per sfoggiare un viola periorbitale da coma etilico e far brillare i tuoi pori ostruiti come costellazioni di notte.', 'ESTETICA & BELLEZZA BRUTTA', 6),
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '8 MIN READ',
    heroImage: getBrutalistAiImageUrl('Dalla Scottona di primo taglio per la muscolatura dei martiri al macinato grasso per lo sguardo della Madonna: viaggio nell\'atelier d\'alta macelleria sulla pelle dentro la Città del Vaticano.', 'TATUAGGI CARNEI & SACRI', 7),
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '6 MIN READ',
    heroImage: getBrutalistAiImageUrl('Dall\'evocare l\'ex come unità di misura del cibo al pagare il conto con 700 monetine di rame: 10 mosse infallibili per garantire un blocco immediato su WhatsApp.', 'ACCOPPIAMENTO & DINTORNI', 8),
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '7 MIN READ',
    heroImage: getBrutalistAiImageUrl('Dall\'iconico \'Ho visto cose che voi umani\' alle corse disperate sulla spiaggia inseguiti dai cameraman: guida definitiva alla fenomenologia del crollo amoroso in diretta TV.', 'TEMPTATION & DISSOCIAZIONE', 9),
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '6 MIN READ',
    heroImage: getBrutalistAiImageUrl('Dalle allucinazioni sui codici fiscali alla ricetta della carbonara coi sassi: storia del disastro AI nostrano che ha fatto sbellicare la Silicon Valley e disperare la Pubblica Amministrazione.', 'DISSOCIAZIONE TECNOLOGICA', 10),
  ...
  },
  {
    ...
    date: '24 LUGLIO 2026',
    readTime: '4 MIN READ',
    heroImage: getBrutalistAiImageUrl('Le prove inquietanti dietro gli occhi socchiusi. Un\'indagine esclusiva della redazione di Alter Ego.', 'COMPLOTTO FELINO', 11),
  ...
  },
  {
    ...
    date: '23 LUGLIO 2026',
    readTime: '3 MIN READ',
    heroImage: getBrutalistAiImageUrl('Tre ingredienti che non dovresti mai unire: un tostapane difettoso, la solitudine e le aspettative sociali.', 'CUCINA DA INCUBO', 12),
  ...
  },
  {
    ...
    date: '22 LUGLIO 2026',
    readTime: '5 MIN READ',
    heroImage: getBrutalistAiImageUrl('Un corso accelerato per insegnare il niente a chi non vuole sapere niente. Senza alcuno sforzo.', 'FILOSOFIA DEL NULLA', 13),
  ...
  },
  {
    ...
    date: '21 LUGLIO 2026',
    readTime: '6 MIN READ',
    heroImage: getBrutalistAiImageUrl('Dall\'abito sacco dell\'immondizia Haute Couture alle scarpe trasparenti che creano la condensa ai piedi.', 'MODA CRINGE', 14),
  ...
  },
  {
    ...
    date: '20 LUGLIO 2026',
    readTime: '4 MIN READ',
    heroImage: getBrutalistAiImageUrl('Quando il tuo inconscio prende il controllo ed effettua acquisti impulsivi di cactus alle 4 del mattino.', 'FILOSOFIA DEL NULLA', 15),
  ...
  },
  {
    ...
    readTime: '1 MIN READ',
    heroImage: getBrutalistAiImageUrl('Rifiuta la logica, la produttività tossica e i fogli Excel. Firma l\'atto solenne di irrilevanza volitiva.', 'MANIFESTI & ATTI', 16),
  ...
  },
  {
    ...
    date: '19 LUGLIO 2026',
    readTime: '3 MIN READ',
    heroImage: getBrutalistAiImageUrl('La tua lampada da tavolo ti sta giudicando. Ecco cosa dicono le stelle per gli elettrodomestici di casa.', 'OROSCOPO OGGETTI', 17),
